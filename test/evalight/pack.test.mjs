...
assert.ok(files["evalight/project.mjs"].includes("classifyProject"));
assert.ok(files["evalight/clj.mjs"].includes("startCljRuntime"));
assert.ok(files["evalight/runtime.mjs"].includes("startRuntime"));
